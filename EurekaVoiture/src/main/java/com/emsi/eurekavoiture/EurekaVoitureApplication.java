package com.emsi.eurekavoiture;

import com.emsi.eurekavoiture.Models.Client;
import com.emsi.eurekavoiture.Models.Voiture;
import com.emsi.eurekavoiture.Repositories.VoitureRepository;
import com.emsi.eurekavoiture.Services.ClientService;
...
@EnableFeignClients
public class EurekaVoitureApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(EurekaVoitureApplication.class, args);
    }
